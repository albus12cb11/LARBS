...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/albus12cb11/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/albus12cb11/LARBS/master/progs.csv"
